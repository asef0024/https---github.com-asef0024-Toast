...
Simple Persona is a free, simple yet feature-rich personal blog WordPress theme for professionals to craft their personal websites and blogs.
...
For more information about Simple Persona please go to https://catchthemes.com/themes/simple-persona-pro/

== Installation ==

1. In your admin panel, go to Appearance -> Themes and click the 'Add New' button.
2. Type in Simple Persona in the search form and press the 'Enter' key on your keyboard.
3. Click on the 'Activate' button to use your new theme right away.
4. Go to https://catchthemes.com/theme-instructions/simple-persona/ for a guide on how to customize this theme.
...
You can check our Theme Instructions at https://catchthemes.com/themes/simple-persona in the Theme Instructions Tab.

= Where can I find theme demo? =

You can check our Theme Demo at https://catchthemes.com/demo/simple-persona/
...
= 2.1.3 (Released: September 10, 2021) =
* Added: Link in the Portfolio post title
* Bug Fixed: Multi flex-height, changed to flex-height and flex-width

= 2.1.2 (Released: August 28, 2020) =
* Removed: Cycle slider shuffle not compatible with theme check
* Updated: WP 5.5 Compatibility

= 2.1.1 (Released: May 25, 2020) =
* Bug Fixed: $post variable in featured content

= 2.1 (Released: May 21, 2020) =
* Added: Support for wp_body_open action
* Bug Fixed: HTML h1 tag issue
* Bug Fixed: Multi Category Sanitization issue
* Updated: Meta Styles
* Updated: readme.txt and style.css as per the new requirements

= 2.0.2 (Released: January 30, 2019) =
* Bug Fixed: Spacing in end of infinite scroll
* Bug Fixed: Spacing issue in section

= 2.0.1 (Released: January 24, 2019) =
* Updated: Blocks css
* Updated: Blocks editor styles
...
* Added: Theme support for for editor styles
* Updated: Author info design
* Updated: Testimonial design
* Updated: Responsive design
* Updated: Design for calendar widget, RSS widget & Recent Posts widget
* Updated: Editor Styles
* Updated: Optimized css for portfolio section
* Updated: Metabox UI
* Updated: Readme file as per new requirement

= 1.0.2 (Released: October 25, 2018) =
* Bug Fixed: Testimonial Typo corrected
* Updated: Screenshot

= 1.0.1 (Released: August 01, 2018) =
* Bug Fixed: Header Featured Image issue in Blog Page
* Updated: Upgrade to pro button css
* Updated: Content delivered through the_content filter

= 1.0 (Released: July 05, 2018) =
...
= 0.4 (Released: May 04 2018) =
* Bug Fixed: Text Domain in style.css file (Reported by: kevinhaig)

= 0.3 (Released: March 18 2018) =
* Bug Fixed: Design issue with Catch Infinite Scroll plugin

= 0.2 (Released: March 08 2018) =
* Bug Fixed: Page Title not displaying in static front page
* Bug Fixed: Inner page header image issue
* Bug Fixed: Added missing header image thumbnail for preview in customizer
* Big Fixed: Header Image Issue
* Bug Fixed: Image size hard cropped for Archive Image Top
* Bug Fixed: Single Page/Post metabox index value
* Bug Fixed: Removed unnecessary function
* Bug Fixed: Testimonial slider scripts loading
* Changed: Default Portfolio Number
* Bug Fixed: Testimonial section text alignment css fixed when slider is unchecked

= 0.1 (Released: Feb 08 2018) =
* Initial release

== Copyright ==

Simple Persona WordPress Theme, Copyright 2018 Catchthemes.com
Simple Persona is distributed under the terms of the GNU General Public License v2
...
* Images
	...
	Header Image and Screenshot main image
		* https://www.pexels.com/photo/color-double-exposure-man-532392/

	Other Screenshot Images
		* https://www.pexels.com/photo/address-business-card-cards-company-269843/
		* https://www.pexels.com/photo/coffee-communication-computer-connection-461073/

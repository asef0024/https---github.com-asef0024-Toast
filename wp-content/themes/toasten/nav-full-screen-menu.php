...
<div id="fullscreen-site-header-menu" class="fullscreen-site-header-menu">
	<div class="fullscreen-menu-wrapper">
		<div class="fullscreen-menu-toggle-wrapper">
			<button id="fullscreen-menu-toggle"  class="fullscreen-menu-toggle" aria-controls="fullscreen-menu" aria-expanded="false"><?php echo scapeshot_get_svg( array( 'icon' => 'menu' ) ); echo scapeshot_get_svg( array( 'icon' => 'cancel' ) ); ?></button>
